...
title: Update Octofit Tracker Django App

description: |
  Update the Django backend to support MongoDB, CORS, and collections for users, teams, activities, leaderboard, and workouts. Ensure API root is configured.
